        ...
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50
            ...
            <div className="lg:w-1/2 p-8 text-center lg:text-left">
                ...
                <p className="text-lg text-gray-600 mb-6">
                    ...
                    and function. Designed to make you look and feel your best every day.
                </p>
                <Link to="/collections/all" className="bg-black text-white px-6 py-3 rounded-lg text-lg hove:bg-gray-800">
                    Shop Now
                </Link>
            </div>
